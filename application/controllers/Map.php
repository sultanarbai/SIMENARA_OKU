...
class Map extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (isset($_POST['cat'])) {
            ...
            if ($kategori != 'semua') {
                $datapage['datatabel1'] = $this->Model2->wereAND('tb_menara', 'sumber_data', 'kode_kecamatan', $v_thn, $kategori);
                $thn = $v_thn;
                $datapage['zona'] = $this->Model2->ambil_where2('tb_zona', $kategori, 'kode_kecamatan');
                $datapage['datatabel2'] = $this->Model2->ambil_where2('tb_kecamatan', $kategori, 'kode_kecamatan');
            }
            if ($kategori == 'semua') {
                // $datapage['datatabel1'] = $this->Model2->wereAND('tb_menara', 'sumber_data', 'provider', $v_thn, 'TLKMv');
                $datapage['datatabel1'] = $this->Model2->ambil_where2('tb_menara', $v_thn, 'sumber_data');
                $thn = $v_thn;
        ...
        $datapage['url'] = "map";
        $datapage['thnn'] = $thn;
        $datapage['title'] = "Map Menara";
        $datapage['subtitle'] = "";

        $datapage['tahun'] = $this->Model2->select_disting();


        $data['menara'] = $this->load->view('map/v_map', $datapage, TRUE);
    ...
    public function findmap()
    {
        ...
        $datacontent['title'] = 'Pengecekan Koordinat';
        $data['menara'] = $this->load->view('map/v_findmap', $datacontent, TRUE);
