...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel tile">
        <div class="x_title">
            <h2>Form Tambah Akun Pegawai</h2>
        ...
        <div class="x_content">
            ...
            <br />
            <form class="user" method="post" action="<?= site_url($url) ?>/form_tambah">

                <div class="form-group row">
                    <label for="nip" class="col-sm-2 col-form-label">NIP</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nip" name="nip" value="<?= $nip ?>" maxlength="20" required>
                    </div>
                </div>
                <?php if ($nip_err != '') {
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_pegawai" name="nama_pegawai" value="<?= $nama ?>" maxlength="50" required>
                    </div>
                </div>
                <?php if ($nama_err != '') {
                    echo '<div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="no_hp" name="no_hp" value="<?= $no_hp ?>" maxlength="15" required>
                    </div>
                </div>
                <?php if ($nohp_err != '') {
                    echo '<div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="col-sm-2 col-form-label" id="kode_role" name="kode_role" required>
                            <option value="">---pilih role akun---</option>
                            <?php
                            foreach ($datatabel4->result() as $row2) {
                            ?>
                                <option value="<?= $row2->kode_role; ?>"><?= $row2->nama_role; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="alamat" name="alamat" value="<?= $alamat ?>" maxlength="400" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <p>
                            Belum Valid ==>
                            <input type="radio" class="flat" name="status" id="0" value="0" checked="" required />
                            Valid ==>
                            <input type="radio" class="flat" name="status" id="1" value="1" />
                        </p>
                    </div>
                </div>
