...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel tile">
        ...
        <div class="x_content">
            ...
            <br />
            <form class="user" method="post" action="<?= site_url('kecamatan/form_ubah/' . $datatabel->kode_kecamatan) ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_kecamatan" name="nama_kecamatan" value="<?= $datatabel->nama_kecamatan ?>" maxlength="30" required>
                    </div>
                </div>
                <?php if ($err2 != '') {
                    echo '<div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="jumlah_penduduk" name="jumlah_penduduk" value="<?= $datatabel->jumlah_penduduk ?>" min="0" required>
                    </div>
                </div>
                <?php if ($err3 != '') {
                    echo '<div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="float" class="form-control" id="laju_pertumbuhan" name="laju_pertumbuhan" value="<?= $datatabel->laju_pertumbuhan ?>" required>
                    </div>
                </div>
                <?php if ($err4 != '') {
                    echo '<div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="float" class="form-control" id="luas_wilayah" name="luas_wilayah" value="<?= $datatabel->luas_wilayah ?>" required>
                    </div>
                </div>
                <?php if ($err5 != '') {
                    echo '<div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="float" class="form-control" id="sumber_data" name="sumber_data" value="<?= $datatabel->sumber_data; ?>" maxlength="4" required>
                    </div>
                </div>
                <?php if ($err6 != '') {
                    echo '<div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="float" class="form-control" id="teledensitas" name="teledensitas" value="<?= $datatabel->teledensitas; ?>" required>
                    </div>
                </div>
                <?php if ($err7 != '') {
                    echo '<div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="float" class="form-control" id="ratarata_pngl" name="ratarata_pngl" value="<?= $datatabel->ratarata_pngl; ?>" required>
                    </div>
                </div>
                <?php if ($err8 != '') {
                    echo '<div class="form-group row">
