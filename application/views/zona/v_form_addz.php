...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel tile">
        <div class="x_title">
            <h2>Form Tambah Zona</h2><button class="btn btn-warning"><a href="<?= site_url('zona') ?>" style="color: white ;"><i class="fa fa-times"></i> Cancel</a></button>
        ...
        <!-- form elegan -->
        <div class="x_content">
            <form class="form-label-left input_mask" method="post" action="<?= site_url() ?>zona/form_tambah">

                <div class="col-md-4 col-sm-4  form-group has-feedback">
                    <div class="form-group">
                        <input type="text" class="form-control has-feedback-left" name="site_id" id="inputSuccess2" value="<?= $data1 ?>" placeholder="Site Id" required>
                    ...
                    <div class="form-group">
                        <select class="form-control has-feedback-left" id="kecamatan" name="kecamatan" required>
                            ...
                            ?>
                                <option value="<?= $row2->kode_kecamatan; ?>"><?= $row2->nama_kecamatan; ?></option>
                            <?php } ?>
                        </select>
                        <span class="form-control-feedback" aria-hidden="true"></span>
                        <?php if ($err2 != '') {
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control has-feedback-left" name="latitude" id="latitude" value="<?= $data3 ?>" placeholder="Latitude" required>
                        <span class="form-control-feedback" aria-hidden="true"></span>
                        <?php if ($err3 != '') {
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control has-feedback-left" name="longitude" id="longitude" value="<?= $data4 ?>" placeholder="Longitude" required>
                        <span class="form-control-feedback" aria-hidden="true"></span>
                        <?php if ($err4 != '') {
                    ...
                    <div class="form-group">
                        ...
                        <p>
                            New :
                            <input type="radio" class="flat" name="status" id="new" value="new" checked="" required />
                        </p>
                        <p>
                            Eksisting :
                            <input type="radio" class="flat" name="status" id="eksisting" value="eksisting" />
                        </p>
                    </div>
                    <div class="form-group">
