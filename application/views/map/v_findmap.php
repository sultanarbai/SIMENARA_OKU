...
<script>
    function initialize() {
        ...
        var map = L.map('map', {
            center: [-4.124545859416439, 104.32779541015626],
            zoom: 10,
            layers: [osm, kecoku, menara, zonanew, zonaeksisting]
        });
        ...
        layerControl.addOverlay(atribut, 'Atribut');
        ...
        <?php } else { ?>
            // -------On Click--------
            var popup = L.popup()
                .setLatLng([-4.124545859416439, 104.42779541015626])
...
<!-- //batas LEAFLET -->
<form method="post" action="<?= site_url('map/findmap') ?>">
    <div class="col-sm-12">
